          ...
          msg.id ? (
            ...
            <>
              ...
              <ReactionBar
                ...
                onToggle={(emoji) => toggleReaction(msg, emoji, isDM)}
              />
            </>
          )}
        </div>
  ...
  return (
    ...
    >
        ...
        <div className="user-panel">
          ...
          >
            ...
            <span className="user-status-text">
              <PresenceIndicator status={profile.presence_status || 'online'} size="inline" />
              <span>
                {profile.custom_status || (profile.presence_status || 'online').replace('dnd', 'do not disturb')}
              </span>
            </span>
      ...
      {showAppearanceSettings && (
        ...
        >
          <div
            className="settings-modal appearance-modal"
            onClick={(event) =>
              event.stopPropagation()
            }
          >
            <div className="settings-header">
              <div>
                ...
                <p className="settings-subtitle">Tune colors, wallpaper and transparency in real time.</p>
              </div>
